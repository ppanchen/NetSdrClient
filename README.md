...
[![Quality Gate Status]([![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=Starenkiyy_NetSdrClient&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=Starenkiyy_NetSdrClient))
